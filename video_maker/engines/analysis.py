...
- Это анимация логотипа, БЕЗ смысловой нагрузки
- Ставь intro ТОЛЬКО в начале видео (start=0), если первые 3-4 секунды — тишина или пауза в речи
- Если речь начинается сразу — intro НЕ ставь

АНАЛИЗ:
- Определи где в тексте есть тихие паузы (2+ секунды тишины) — это кандидаты на middle
- Определи конец видео — это outro (последние 3-5 секунд)
- Выдели 5-10 сильных слов для визуального выделения (капс, цвет)
