...
# REPLACE: video_maker/engines/analysis.py
...
═══════════════════════════════════════
A) hooks_wide (16:9) — 2–4 шт: умный/сериальный тон, 3–7 слов, start/end, показ ~5с
...
- hook_start / hook_end: АБСОЛЮТНЫЕ секунды на таймлайне полного ролика
  (hook_start ≈ start клипа, длительность показа ~5с)
- cta: 3–7 слов — вопрос в комментарии (≠ hook)
- cta_start / cta_end: АБСОЛЮТНЫЕ, последние ~7с клипа (cta_end ≈ end)
- title ≤ 40 символов
...
{{
  ...
  "hooks_wide": [
    {{"text": "ПЕРЕПИСАННЫЙ хук для 16:9", "start": 0.0, "end": 5.0, "type": "CURIOSITY", "visual_weight": "L3"}}
  ],
  "hooks_vertical": [
    {{"text": "ДРУГОЙ переписанный хук для 9:16", "start": 0.0, "end": 5.0, "type": "CURIOSITY", "visual_weight": "L3"}}
  ],
  "hooks": [
    {{"text": "fallback = hooks_vertical", "start": 0.0, "end": 5.0, "type": "CURIOSITY", "visual_weight": "L3"}}
  ],
  "hook": {{"text": "главный хук", "start": 0.0, "end": 5.0, "timing": 0.0}},
  ...
  "subtitles": [
    {{"start": 0.0, "end": 5.0, "text": "фраза субтитра", "style": "normal"}}
  ]
}}"""
